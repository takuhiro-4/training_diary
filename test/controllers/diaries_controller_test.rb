...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { name: @diary.name, start_time: @diary.start_time } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { name: @diary.name, start_time: @diary.start_time } }
